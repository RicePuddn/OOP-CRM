...
import com.olivecrm.service.LoginService;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.PostMapping;
import org.springframework.web.bind.annotation.RequestBody;
import org.springframework.web.bind.annotation.RequestMapping; // Corrected the class name to follow conventions
...
public class EmployeeController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginDTO loginRequest) {
        try {
            Employee employee = loginService.login(loginRequest.getUsername(),
